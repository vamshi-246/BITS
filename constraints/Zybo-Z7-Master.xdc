...
#set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { stop }]; #IO_L24P_T3_34 Sch=sw[1]
...
#set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { min[0] }]; #IO_L23N_T3_35 Sch=led[1]
